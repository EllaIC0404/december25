...
# def test_merge_data(stock_file, sales_file):
#     # Arrange - set up input and expected output
#     stock_filepath = 'stock_data.csv'
#     sales_filepath = 'sales_data.csv'
#     expected_length = 2
#     expected_id = 123
#     expected_quantity_in_stock = 10
#     expected_sales = 5

#     # Act
#     stock_data = read_csv(stock_filepath)
#     sales_data = read_csv(sales_filepath)
#     merged_data = merge_data(stock_data, sales_data)

#     # Assert
#     assert len(merged_data) == expected_length
#     assert merged_data[1][0] == expected_id
#     assert merged_data[1][2] == expected_quantity_in_stock
#     assert merged_data[1][3] == expected_sales
